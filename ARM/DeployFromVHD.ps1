...
if($ResourceGroup.ResourceGroupName -eq "Create New"){
    ...
    Write-Host "Creating new Availability Set `"$($ResourceGroup.ResourceGroupName)`""
...
if($AvailabilitySet -eq "Create New"){
    ...
    Write-Host "Creating new Availability Set `"$AvailabilitySet`""
...
Write-Host "Virtual Network: $VirtualNetwork"
...
if($VirtualNetwork.Name -eq "Create New"){
    ...
    Write-Host "Creating new Virtual Network `"$($VirtualNetwork.Name)`""
    ...
    Write-Host "Updating Virtual Network `"$($VirtualNetwork.Name)`""
...
if($PublicIP.Name -eq "Create New"){
    ...
    Write-Host "Creating new Public IP `"$($PublicIP.Name)`""
...
if($Nic.Name -eq "Create New"){
    ...
    Write-Host "Creating new NIC `"$($Nic.Name)`""
    if($PublicIP -eq $null){
...
if($NicType -eq "Multiple NIC"){
    ...
    Write-Host "Secondary Subnet: $SecondarySubnet"
